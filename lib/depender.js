...
(function() {
  ...
  root.define = function() {
    var action, actions, callback, defer, dependencies, namespace, path, procesding, _i, _j, _len, _len1;
    switch (arguments.length) {
      case 2:
        dependencies = arguments[0], callback = arguments[1];
        namespace = window;
        break;
      case 3:
        path = arguments[0], dependencies = arguments[1], callback = arguments[2];
